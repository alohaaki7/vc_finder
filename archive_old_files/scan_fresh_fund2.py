...
def main():
    input_file = os.path.join(SCRIPT_DIR, "FRESH_FUND_II_VCS.csv")
    output_file = os.path.join(SCRIPT_DIR, "FRESH_FUND_II_REDESIGN_TARGETS.csv")
    ...
    print(f"  ✓ Saved to: FRESH_FUND_II_REDESIGN_TARGETS.csv")
    print(f"{'='*60}")
